// backtest_spike_catching.js
/**
 * 1-Month SMC Historical Backtest: SPIKE-CATCHING STRATEGY
 * Rules:
 *  - Boom Pairs  (BOOM1000, BOOM900, BOOM600, BOOM500)   -> BUY ONLY  (Bullish OB entries)
 *  - Crash Pairs (CRASH1000, CRASH900, CRASH600, CRASH500) -> SELL ONLY (Bearish OB entries)
...
// Enforce Spike-Catching Mode programmatically
config.BOOM_CRASH_MODE = 'SPIKE_CATCHING';
...
async function main() {
  ...
  console.log(`\n${BOLD}${CYAN}=================================================================================================`);
  console.log(`🚀 1-MONTH HISTORICAL BACKTEST: SPIKE-CATCHING STRATEGY`);
  console.log(`=================================================================================================${RESET}`);
  console.log(`Operating Mode   : SPIKE_CATCHING (Boom = BUY ONLY | Crash = SELL ONLY)`);
  ...
  for (const symbol of symbols) {
    ...
    try {
      ...
      console.log(`  * Running chronological Spike-Catching backtest...`);
  ...
  console.log(`\n${BOLD}================================= SPIKE-CATCHING PERFORMANCE REPORT =================================${RESET}`);
  ...
  console.log(`\n${BOLD}${CYAN}📊 CONSOLIDATED SPIKE-CATCHING METRICS (1 MONTH):${RESET}`);
  console.log(`-------------------------------------------------------------------------------------------------`);
